        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-4">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"  class="transition ease-in bg-gray-100 text-red hover:bg-red-600 hover:text-white px-3 py-2 rounded-full text-sm shadow hover:shadow-xl">
